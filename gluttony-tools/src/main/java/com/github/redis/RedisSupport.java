...
public class RedisSupport {
    ...
    public Long incrBy(final String key, final long step, final int defaultExpire) {
        String script = "local current = redis.call('incrBy',KEYS[1],ARGV[1]);" +
                ...
                "return current";
        if (defaultExpire > 0) {
            Object result = jedisCluster.eval(script, 1, key, String.valueOf(step), String.valueOf(defaultExpire));
    ...
    public Long incr(final String key, final int defaultExpire) {
